...
class SalesReturnController extends GetxController {
  ...
  void getSales() {
    ...
    salesReturnProvider.fetchByColumn(storage.read("access"), ApiConstants.filter, data).then((response) async {
  ...
  void choosePDFType(BuildContext context) {
    if(selected_sales.isEmpty) {
      ...
      goto("/singleSalesPDF", arguments: {"selected" : selected_sales, "type" : "M"});
    }
  }
