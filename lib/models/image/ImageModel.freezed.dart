...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, int p_id, String path});
}
...
class _$ImageModelImpl implements _ImageModel {
  _$ImageModelImpl({required this.id, required this.p_id, required this.path});
  ...
  @override
  String toString() {
    return 'ImageModel(id: $id, p_id: $p_id, path: $path)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, p_id, path);
...
abstract class _ImageModel implements ImageModel {
  factory _ImageModel(
      ...
      required final String path}) = _$ImageModelImpl;
