...
abstract class $OrderListModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, int code, String message, List<OrderModel>? data});
}
...
class _$OrderListModelImpl implements _OrderListModel {
  ...
  @override
  String toString() {
    return 'OrderListModel(status: $status, code: $code, message: $message, data: $data)';
  }
...
abstract class _OrderListModel implements OrderListModel {
  factory _OrderListModel(
      ...
      final List<OrderModel>? data}) = _$OrderListModelImpl;
