...
abstract class $BannerModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String image, String type, int? cat_id});
}
...
class _$BannerModelImpl implements _BannerModel {
  _$BannerModelImpl(
      {required this.id, required this.image, required this.type, this.cat_id});
  ...
  @override
  String toString() {
    return 'BannerModel(id: $id, image: $image, type: $type, cat_id: $cat_id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, image, type, cat_id);
...
abstract class _BannerModel implements BannerModel {
  factory _BannerModel(
      ...
      final int? cat_id}) = _$BannerModelImpl;
